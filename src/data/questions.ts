export const QUESTIONS = [
  ...
  {
    id: 2,
    question: "When you don't understand a topic, what do you do?",
    options: [
  ...
  {
    id: 4,
    question: "What's the best way for you to remember information?",
    options: [
  ...
  {
    id: 5,
    question: "How do want to be taught?",
    options: [
      "Draw them a map",
  ...
  {
    id: 6,
    question: "What makes it easy to stay concentrated?",
    options: [
